...
[![Deployed on Vercel](https://img.shields.io/badge/Dashboard-Vercel-black?logo=vercel)](https://scavenger-ui.vercel.app)
[![Backend on DigitalOcean](https://img.shields.io/badge/Engine-DigitalOcean_FRA1-blue?logo=digitalocean)](#)
[![Python](https://img.shields.io/badge/Python-3.12-3776AB?logo=python&logoColor=white)](#)
[![React + Vite](https://img.shields.io/badge/React_Vite-20232A?logo=react&logoColor=61DAFB)](#)
...
1. Build signature header with millisecond timestamp
2. Combine header with operation data
3. Recursively sort all JSON keys alphabetically
4. Create compact JSON with no whitespace
5. Sign UTF-8 bytes with Ed25519 private key
...
| Liquidation Type | Direction | Price Effect | Bot Action |
|---|---|---|---|
| Long liquidated | `close_long` | Forced selling → price dips | Buy (bid) |
| Short liquidated | `close_short` | Forced buying → price spikes | Sell (ask) |
...
**Dashboard:** [https://scavenger-ui.vercel.app](https://scavenger-ui.vercel.app)
...
```bash
git clone https://github.com/YOUR_USERNAME/scavenger-v2.git
cd scavenger-v2
